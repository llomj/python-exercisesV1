...
1. **Level 8 FR 2601–2650** — `level8_expert_a.ts` Q1–50. Vérifier **2601:** (actuellement anglais abstract class) et **2651:** (`Lorsqu'une classe hérite…`) avant START/END du patch.
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2600 done** (`level8.ts` + `level8_intermediate_a.ts` + `level8_intermediate_b.ts`) ; reprendre **2601+** (`level8_expert_a.ts`).
