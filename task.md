...
1. **Level 9 FR 2751–2800** — `level9.ts` Q51–100 (encapsulation `__x`, properties, ABC, etc.) ; START première ligne **2751:** ; END première ligne **2801:** (vérifier avec `grep` avant patch).
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2700 done**. **Level 9 FR : 2701–2750 done** (`level9.ts` Q1–50) ; reprendre **2751–2800** (`level9.ts` Q51–100, END **2801:**).
