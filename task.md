...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2650 done** (`level8.ts` + `level8_intermediate_a.ts` + `level8_intermediate_b.ts` + début `level8_expert_a.ts`) ; reprendre **2651+** (MRO / exceptions — boundary **2701:**).
