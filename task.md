...
1. **Level 10 FR 3001+** — Banque : IDs **3001–3300** (`questionsBank.ts` : niveau 10). Vérifier d’abord si `detailedExplanationsTranslations.ts` contient déjà des clés **3001:** … **3300:** alignées ; sinon repérer le premier bloc anglais / hors-banque et patcher par lots (ex. 3001–3050) comme pour les niveaux précédents.
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2700 done**. **Level 9 FR : 2701–3000 done**. **Level 10 FR : à démarrer (3001–3300)** — cartographier les clés existantes dans `detailedExplanationsTranslations.ts` puis continuer par lots.
