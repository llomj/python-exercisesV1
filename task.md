...
1. **Level 8 FR 2501–2550** — `level8_intermediate_a.ts` Q1–50. **Attention :** le texte actuel à **2501** (`Toute classe… __mro__`) ne correspond **pas** à la banque (Q1 = classe `V` et `__eq__` sur `x`) : remplacer le bloc **2501–2550** (END probable : ligne **`2551:`** en anglais sur sous-classe de builtins — vérifier avant patch).
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2500 done** (`level8.ts` complet) ; reprendre **2501+** (`level8_intermediate_a.ts` — réaligner le vieux texte **2501**).
