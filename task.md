...
1. **Level 8 FR 2451–2500** — suite de `level8.ts` (`level8Patterns` Q51–100) ; la banque commence par **`__str__`** (ID **2451**), alors que `detailedExplanationsTranslations.ts` a encore du texte **name mangling / `__x`** à la ligne **2451** : à remplacer en bloc. END patch : ligne **`2501:`** (`__mro__` — vérifier l’exactitude du START/END avant d’exécuter le script).
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2450 done** ; reprendre **2451+** (suite `level8.ts` puis 2501+).
