...
1. **Level 9 FR 2701–2750** (ou premier segment aligné banque) — vérifier **2701:** (exceptions / `try` — texte actuel FR long) et borne suivante (**2751:** dans le fichier : attention indentation historique parfois sans espaces devant l’ID) via `grep` avant START/END.
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2700 done** (tout le niveau 8) ; reprendre **Level 9 — 2701+** (boundary suivante vers **2751** / **2801** selon alignement banque).
