...
1. **Level 9 FR 2851–2900** — `level9_intermediate_b.ts` (50 questions, IDs **2851–2900**) ; END attendu : première ligne **2901:** (vérifier avec `grep '^  2901:'` dans `detailedExplanationsTranslations.ts`).
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2700 done**. **Level 9 FR : 2701–2850 done** (`level9.ts` Q1–100 + `level9_intermediate_a.ts` Q1–50) ; reprendre **2851–2900** (`level9_intermediate_b.ts`).
