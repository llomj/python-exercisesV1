...
1. **Level 9 FR 2951–3000** — `level9_expert_b.ts` (50 questions, IDs **2951–3000**) ; START = première ligne **2951:** (actuellement LBYL partiellement anglais) ; END = première ligne **`402:`** (bloc Level 1 `lstrip` — ne pas inclure cette entrée dans le remplacement).
...
Level 1 `301-600` French in-depth pass: **done through ID `600`**. Level 2: **601–900 done**. Levels 3–5: **901–1800 done**. **Level 6 FR : 1801–2100 done**. **Level 7 FR : 2101–2400 done**. **Level 8 FR : 2401–2700 done**. **Level 9 FR : 2701–2950 done** ; reprendre **2951–3000** (`level9_expert_b.ts`).
