export const translations = {
  en: {
    ...
    hub: {
      ...
      reviewMistakes: "REVIEW WEAK SPOTS",
      reviewModeLabel: "REVIEW MODE",
      mistakesMade: "Mistakes Made",
      openWeakSpots: "Open Weak Spots",
      masteredWeakSpots: "Mastered Weak Spots",
    ...
    quiz: {
      ...
      reviewSequencing: "Rebuilding a batch from your recent mistakes and related concepts.",
  ...
  fr: {
    ...
    hub: {
      ...
      reviewMistakes: "RÉVISER LES POINTS FAIBLES",
      reviewModeLabel: "MODE RÉVISION",
      mistakesMade: "Erreurs Faites",
      openWeakSpots: "Points Faibles Ouverts",
      masteredWeakSpots: "Points Faibles Maîtrisés",
    ...
    quiz: {
      ...
      reviewSequencing: "Reconstruction d'une série à partir de vos erreurs récentes et des concepts liés.",
